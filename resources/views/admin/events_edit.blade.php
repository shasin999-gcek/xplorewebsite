        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('admin.events.update', ['event' => $event->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="type" name="type" required>
                                    <option value="Individual" {{ old('type', $event->type) == 'Individual' ? 'selected': '' }} >Individual</option>
                                    <option value="Team"  {{ old('type', $event->type) == 'Team' ? 'selected': '' }}>Team</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" name="description"  rows="5" cols="35" required autofocus>{{ old('description', $event->description) }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('reg_fee') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control" id="reg_fee" name="reg_fee" value="{{ old('reg_fee', $event->reg_fee) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('f_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control" id="f_price" name="f_price" value="{{ old('f_price', $event->f_price_money) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('s_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control" id="s_price" name="s_price" value="{{ old('s_price',  $event->s_price_money) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('t_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control" id="t_price" name="t_price" value="{{ old('t_price',  $event->t_price_money) }}" required autofocus>
...
@section('scripts')
    ...
    <script>
        jQuery(document).ready(function () {
            jQuery('#category_id').select2().select2('val', '{{ old('category_id', $event->category_id) }}' );
            jQuery('#type').select2();
